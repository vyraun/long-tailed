...
@register_criterion('label_smoothed_focal_loss')
class LabelSmoothedFocalLossCriterion(FairseqCriterion):

    def __init__(self, task, sentence_avg, label_smoothing, gamma):
        super().__init__(task)
