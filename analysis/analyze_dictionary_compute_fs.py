...
sorted_scores = [x for x, _ in sorted(zip(sent_scores,sentences), reverse=True)]

print(np.mean(sorted_scores[0:2400]))
print(np.mean(sorted_scores[2400:4800]))
print(np.mean(sorted_scores[4800:7200]))
