...
##### Warning:  The crux of the code, the Focal loss and Anti-Focal loss implementations are available in the fairseq/criterions directory and can be directly used with fairseq. However, the end-to-end code currently is more of a code-dump, rather than a code-release. Please wait until NAACL deadline is over, for a (much better) cleaned-up version. E2E code release date: Nov 24. 2020 10 pm AoE. 
