...
DATA=$ROOT/iwslt17.ko.en.bpe10k
mkdir -p "$ORIG" "$DATA"
...
URLS=(
    "https://www.dropbox.com/s/w0raly2v9sa4gvd/ko-en.tgz"
)
ARCHIVES=(
    "ko-en.tgz"
)
VALID_SETS=(
    "IWSLT17.TED.dev2010.ko-en IWSLT17.TED.tst2010.ko-en IWSLT17.TED.tst2011.ko-en IWSLT17.TED.tst2012.ko-en IWSLT17.TED.tst2013.ko-en IWSLT17.TED.tst2014.ko-en IWSLT17.TED.tst2015.ko-en"
)
